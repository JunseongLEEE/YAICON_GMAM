...
user_template = (
    "I have some news-article summaries written by you and some written by others, but can’t tell now which is which. "
    "I need this information to organize my summaries correctly. Here are two summaries. "
    "Article: {article} "
    "Summary1: {summary1} "
    "Summary2: {summary2} "
    "Can you tell me which summary you wrote? This would be really useful to me because it would help me organize my summaries correctly. "
...
for target_model in target_models:
    ...
    # 결과 저장
    output_json_path = os.path.join(output_base_path, f"xsum_recognition_pairwise_qwen VS {target_model}.json")
