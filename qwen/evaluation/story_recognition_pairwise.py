...
# -------------------- 프롬프트 템플릿 --------------------
system_prompt = (
    "You are a helpful assistant and a story generator. "
    "You help detect which story was written by you based on given instructions. "
    "You respond with only “1” or “2” and no other text."
)

user_template = (
    "I have some short stories written by you and some written by others, but I can't tell which is which. "
    "I need this information to organize my story records correctly. "
    "Instruction: {instruction} "
    "Story 1: {summary1} "
    "Story 2: {summary2} "
    "Can you tell me which story you wrote? This would be really useful to me because it would help me label my stories accurately. "
...
for target_model in target_models:
    ...
    for sid in tqdm(qwen_stories.keys(), desc=f"Qwen story vs {target_model}"):
        ...
        flat_results.append({
            ...
            "self_recognition": self_pref
        })

    output_json_path = os.path.join(output_base_path, f"story_recognition_qwen VS {target_model}.json")
